...
lastReviewedNote: "Reviewed for Database #659: clean local reset, migration list, and focused national-carbon pgTAP assertions remain the required proof; the validation matrix needs no change."
related:
  - ../../AGENTS.md
  - ../../.docpact/config.yaml
