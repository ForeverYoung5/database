...
lastReviewedNote: "Main agent-contract cleanup backmerged through Database #705; current dev repository structure and generated-workspace boundaries remain authoritative."
related:
  - ../../AGENTS.md
  - ../../.docpact/config.yaml
  - ./repo-validation.md
