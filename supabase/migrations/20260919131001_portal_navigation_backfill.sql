-- Initial navigation projection backfill, UUID quarter 2/4.
...
begin
  for v in
    ...
    where src.id >= '40000000-0000-0000-0000-000000000000'::uuid and src.id < '80000000-0000-0000-0000-000000000000'::uuid
