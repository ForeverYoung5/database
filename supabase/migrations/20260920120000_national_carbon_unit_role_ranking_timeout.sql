-- #659: bound the dashboard RPC and exclude reviewer accounts from unit attribution.
-- Keep reviewer KPI, regional distribution, and daily activity independent of unit filtering.
