-- Initial navigation projection backfill, UUID quarter 1/4.
...
begin
  for v in
    ...
    where src.id >= '00000000-0000-0000-0000-000000000000'::uuid and src.id < '40000000-0000-0000-0000-000000000000'::uuid
