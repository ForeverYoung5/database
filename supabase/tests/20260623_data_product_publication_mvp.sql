...
select
  ...
  jsonb_build_object(
    ...
    'input_status_filter', jsonb_build_object('state_code', jsonb_build_object('eq', 100)),
    'eligibility_definition', jsonb_build_object('predicateVersion', 'published-state-code-100:latest-per-id:v2'),
